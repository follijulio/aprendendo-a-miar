...
const NavBar: React.FC = () => {
    ...
    return (
        <div>
            {time ? (<div></div>) : (
                <header className={timeTwo ? "h-0" : "transition-all duration-700 h-20 w-full flex items-center justify-between p-4 bg-gradient-to-t from-black/40 via-black/90 to-black/100 rounded-b-lg shadow-lg shadow-slate-900"}>
